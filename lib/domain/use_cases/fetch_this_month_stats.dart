...
@lazySingleton
class FetchThisMonthStats extends FetchStats{

  FetchThisMonthStats(iFundTransactionRepo,iSaleTransactionRepo):super(iFundTransactionRepo,iSaleTransactionRepo);
