...
@lazySingleton
class FetchThisWeekStats extends FetchStats {

  FetchThisWeekStats(iFundTransactionRepo,iSaleTransactionRepo):super(iFundTransactionRepo,iSaleTransactionRepo);
  ...
  double getSold(List<SaleTransaction> sales, int dayOfWeek) {
    ...
    sales.forEach((element) {
      if (element.createdAt.weekday == dayOfWeek) sold += element.soldAmount.value;
    });
    return sold;
  }
